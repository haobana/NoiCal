...
public:
    ...
    bool openAndCopy(bool bVisable = false);
    bool openAndCopy(const QString& strFile, bool bVisable = false);
    bool open(const QString& strFilePath, bool bVisible = false);
    bool openDocument(bool bVisible = false);
    bool close();
    bool isOpen();
    void save();
