...
Dialog_tee::Dialog_tee(QWidget *parent, int editRow,  const Tee& data) :
...
bool Dialog_tee::check_lineedit()
{
    for(size_t i = 0; i < atten_lineEdits.size(); i++){
...
QList<QStringList> Dialog_tee::getComponentDataAsStringList() const
{
