...
#include "ui_dialog_disp_vent_terminal.h"
#include <cmath>
#define Pi 3.14159265358979323846


Dialog_disp_vent_terminal::Dialog_disp_vent_terminal(QWidget *parent, int editRow,  const Disp_vent_terminal_noise& data) :
    InputBaseDialog(parent),
    editRow(editRow), // 初始化editRow
    ui(new Ui::Dialog_disp_vent_terminal)
{
    ui->setupUi(this);
...
Dialog_disp_vent_terminal::~Dialog_disp_vent_terminal()
{
    delete ui;
}

//获得noi
void* Dialog_disp_vent_terminal::getNoi()
{
    return noi == nullptr ? nullptr : noi;
}

//计算总值 槽函数实现
void Dialog_disp_vent_terminal::calReflNoi()
{
    double D = 0;
...
//计算总值
void Dialog_disp_vent_terminal::total_noi()
{
...
// 槽函数实现
void Dialog_disp_vent_terminal::calTotalNoise() {
...
//关闭窗口按钮
void Dialog_disp_vent_terminal::on_close_clicked()
{
    this->close();
}

//确认按钮
void Dialog_disp_vent_terminal::on_pushButton_confirm_clicked()
{
    this->noi = new Disp_vent_terminal_noise;
...
void Dialog_disp_vent_terminal::on_radioButton_circle_clicked()
{
...
void Dialog_disp_vent_terminal::on_radioButton_rect_clicked()
{
    ui->lineEdit_63_refl->clear();
    ui->lineEdit_125_refl->clear();
    ui->lineEdit_250_refl->clear();
...
void Dialog_disp_vent_terminal::on_radioButton_known_clicked()
{
    ui->lineEdit_63_refl->clear();
    ui->lineEdit_125_refl->clear();
    ui->lineEdit_250_refl->clear();
...
void Dialog_disp_vent_terminal::on_radioButton_formula_clicked()
{
    ui->lineEdit_63_refl->clear();
    ui->lineEdit_125_refl->clear();
    ui->lineEdit_250_refl->clear();
...
void Dialog_disp_vent_terminal::on_pushButton_clicked()
{
    // 使用资源路径
