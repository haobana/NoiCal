...
Dialog_disp_vent_terminal::Dialog_disp_vent_terminal(QWidget *parent, int editRow,  const Disp_vent_terminal& data) :
    ...
    ui(new Ui::Dialog_disp_vent_terminal)
{
    ...
    {
        connect(lineEdit, &QLineEdit::textChanged, this, &Dialog_disp_vent_terminal::calTotalNoise);
    }
...
//获得noi
void* Dialog_disp_vent_terminal::getComponent()
{
...
void Dialog_disp_vent_terminal::on_pushButton_confirm_clicked()
{
    ...
    this->component = new Disp_vent_terminal(
...
bool Dialog_disp_vent_terminal::check_lineedit()
{
...
QList<QStringList> Dialog_disp_vent_terminal::getComponentDataAsStringList() const
{
