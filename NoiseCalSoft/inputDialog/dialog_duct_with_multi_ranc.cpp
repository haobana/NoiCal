...
Dialog_duct_with_multi_ranc::Dialog_duct_with_multi_ranc(QWidget *parent, int editRow,  const Multi_ranc_atten& data) :
...
void* Dialog_duct_with_multi_ranc::getNoi()
{
...
void Dialog_duct_with_multi_ranc::on_pushButton_confirm_clicked()
{
    ...
    {
        noi->getMode = "公式";
        noi->model = "多分支" + ui->lineEdit_q1->text() + "/" + ui->lineEdit_q->text();
    }
...
//计算总值 槽函数实现
void Dialog_duct_with_multi_ranc::calNoise() {
...
//通过厂家信息
void Dialog_duct_with_multi_ranc::on_radioButton_known_clicked()
{
    ui->lineEdit_q->clear();
...
//通过经验公式
void Dialog_duct_with_multi_ranc::on_radioButton_formula_clicked()
{
