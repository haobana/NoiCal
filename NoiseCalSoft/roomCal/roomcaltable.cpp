...
void RoomCalTable::on_comboBox_unit_name_currentTextChanged(const QString &arg1)
{
    ...
    else if(arg1 == "空调器")
    {
        ...
        QList<QString> list_send =
                SystemManager::getInstance().getNoiseComponentsInSystem(systemName, noise_src_component::AIRCONDITION_SINGLE);
        ...
        QList<QString> list_exhaust =
                SystemManager::getInstance().getNoiseComponentsInSystem(systemName,noise_src_component::AIRCONDITION_DOUBLE);
    ...
    {
        ui->comboBox_VAV_terminal_number->blockSignals(true);
        ...
        for(auto& component : this->currentAllComponentList)
        {
            ...
            {
                ui->comboBox_VAV_terminal_number->addItem(vav->model);
            }
        }
        ui->comboBox_VAV_terminal_number->setCurrentIndex(-1);
        ui->stackedWidget_table->setCurrentWidget(ui->page_VAV_terminal);
        ui->comboBox_VAV_terminal_number->blockSignals(false);
    }
